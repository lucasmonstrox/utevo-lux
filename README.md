...
| [bug](plugins/utevo-lux/skills/bug/SKILL.md) | <img src="plugins/utevo-lux/assets/bug.gif" alt="Bug" width="20"> Tracks the bug to its lair and finds the root cause; slays it when asked or with `--fix`. |
