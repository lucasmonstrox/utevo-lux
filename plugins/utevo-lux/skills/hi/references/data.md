...
Settle semantics and guarantees in the discussion. Exact indexes, constraints, expand/backfill/contract migrations and queries belong to `/mission` and `/equip`, guided by the access patterns decided here.
